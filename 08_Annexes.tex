...
Les références citées dans ce mémoire sont consultables via les liens suivants :
...
\begin{enumerate}
  ...
  \item Article 55 du décret n°96-478 du 31 mai 1996, relatif à l'obligation de conservation des archives :\\
  \url{https://www.legifrance.gouv.fr/legi/article/LEGIARTI000006842596}

  \item Portail Géofoncier, portail informatique national de la profession de géomètre-expert :\\
  \url{https://www.geofoncier.fr}

  \item Documentation de l'API REST Géofoncier. Spécifications techniques, DSI OGE, 2024 :\\
  \url{https://api2.geofoncier.fr/api/}

  \item Programme GEODEMAT -- Numérisation du patrimoine cadastral. Ordre des géomètres-experts / Direction générale des Finances publiques, 2021.
\end{enumerate}
...
% ---------------------------------------------------------------------
\subsection*{Annexe F -- Les trois tâches du Table Transformer}
\addcontentsline{toc}{subsection}{Annexe F - Tâches du Table Transformer}
\label{ann:table_transformer}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textheight, angle=90]{img/table_transformer_overview.png}
  \label{fig:table_transformer_annexe}
\end{figure}

\clearpage

% ---------------------------------------------------------------------
\subsection*{Annexe G - Interface de validation du répertoire du Géomètre A}
\addcontentsline{toc}{subsection}{Annexe G - Interface du Géomètre A}
...
\begin{figure}[H]
  ...
  \fbox{\includegraphics[width=0.94\textheight, keepaspectratio, angle=90]{img/5.5_reprtoire_A_liste.jpg}}
...
\begin{figure}[H]
  ...
  \setlength{\fboxsep}{0pt}%
  \setlength{\fboxrule}{0.6pt}%
  \fbox{\includegraphics[height=0.82\textheight, keepaspectratio]{img/5.5_reprtoire_A_infos.jpg}}
