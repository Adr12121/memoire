...
\begin{figure}[H]
    ...
    \caption{Chaîne de reconnaissance de texte imprimé en quatre étapesExtrait de \cite{baek_stract_2019}.}
...
Envoyer directement une photographie ou un scan d'un document à un moteur de lecture pose un problème : la page contient de nombreuse zones potentiellement inintéressantes, ou de nombreuses sources d'erreurs. Si le moteur essaie de tout lire sans tri, ce dernier perd du temps et produit du texte parasite qui peut nuire à la qualité des résultats finaux. Il est donc important d'isoler d'abord les zones d'intérêt dans la page avant d'extraire le texte.
...
D'une part, sur des documents imprimés comme les e-mails (99,5~\%), les CV (98,8~\%) ou les dossiers (96,7~\%), le modèle atteint d'excellents résultats. Dans ces cas, les mots reconnus par l'OCR (comme des entêtes d'e-mail ou des sections de CV) fournissent des repères pouvant être exploité.
