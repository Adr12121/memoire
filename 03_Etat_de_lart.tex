...
Beaucoup de documents  organisent leur contenu en colonnes et en lignes. Repérer la structure d'un tableau dans une image et en extraire le contenu est un problème distinct de la simple lecture de texte. Ce problème a été étudié depuis les travaux de \citet{duda_hough_1972} sur la détection de lignes géométriques.
...
Cette analyse de la mise en page des tableaux est importante pour exploiter les répertoires d'anciens géomètres. Elle permet l'alignement des données avant d'alimenter les modules suivants du projet.
