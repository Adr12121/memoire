...
\begin{itemize}
  ...
  \item Mots-clés détectés par OCR sur la première page : si le PDF est scanné, EasyOCR lit la première page et cherche les mêmes mots-clés, avec une tolérance aux fautes de lecture via du fuzzy matching. Les labels de formulaire trouvés sans valeur en face ("Commune~:" seul, sans texte) signalent un formulaire ancien de type DMPC.
...
Cette correction a pour but de présenter la zone extraite au moteur de lecture sous un format plat et normalisé, quel que soit l'angle ou la déformation d'origine du document.
